...
Study_Only <- c("Study")
Child_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Child_SDOH,
                                                                                    Outcome_Data = child_list_Targeted,
                                                                                    myexposures = NULL,
                                                                                    myoutcomes = child_analytes,mycovars = Study_Only,join_var = "Child_PID",
                                                                                    Reg_Type = "Quantile")))

Child_Study_Quantile_Results <- Child_SDOH_Metab_Quantile_Results
save(Child_Study_Quantile_Results, file = "../Output/Final_Paper1_Output/Child_Study_Quantile_Results.RData")

focused_social_exposures <- c("Mat_Age","Mat_Race","Mat_Edu","Child_Sex", 
                              "Child_Race","Mat_Income","Max_Edu","Mat_Edu_Binary","Child_Age","Mat_Income_Binary",
                              "Mat_Child_Comb_Race","Location_Country")

#Run Quantile ExWAS
Child_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Child_SDOH,
                                                                                    Outcome_Data = child_list_Targeted,
                                                                                    myexposures = focused_social_exposures,
...
save(Child_All_Exposure_Quantile_Results, file = "../Output/Final_Paper1_Output/Child_Quantile_Results_Study_Adj.RData")

Age_Sex <- c("Child_Age","Child_Sex")
Child_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Child_SDOH,
                                                                                    Outcome_Data = child_list_Targeted,
                                                                                    myexposures = NULL,
                                                                                    myoutcomes = child_analytes,mycovars = Age_Sex,join_var = "Child_PID",
                                                                                    Reg_Type = "Quantile")))

Child_Age_Sex_Quantile_Results <- Child_SDOH_Metab_Quantile_Results
save(Child_Age_Sex_Quantile_Results, file = "../Output/Final_Paper1_Output/Child_Quantile_Results_AgeSex.RData")

Age_Sex_Study <- c("Child_Age","Child_Sex","Study")
Child_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Child_SDOH,
                                                                                    Outcome_Data = child_list_Targeted,
                                                                                    myexposures = NULL,
                                                                                    myoutcomes = child_analytes,mycovars = Age_Sex_Study,join_var = "Child_PID",
                                                                                    Reg_Type = "Quantile")))

Child_Age_Sex_Study_Quantile_Results <- Child_SDOH_Metab_Quantile_Results
save(Child_Age_Sex_Study_Quantile_Results, file = "../Output/Final_Paper1_Output/Child_Quantile_Results_AgeSexStudy.RData")

Age_Sex_Study <- c("Child_Age","Child_Sex","Mat_Child_Comb_Race","Study")
Child_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Child_SDOH,
                                                                                    Outcome_Data = child_list_Targeted,
                                                                                    myexposures = NULL,
                                                                                    myoutcomes = child_analytes,mycovars = Age_Sex_Study,join_var = "Child_PID",
...
Child_Age_Sex_Study_Race_Quantile_Results <- Child_SDOH_Metab_Quantile_Results
save(Child_Age_Sex_Study_Race_Quantile_Results, file = "../Output/Final_Paper1_Output/Child_Age_Sex_Study_Race_Quantile_Results.RData")

Age_Sex_Study <- c("Child_Age","Child_Sex","Mat_Income_Binary","Study")
Child_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Child_SDOH,
                                                                                    Outcome_Data = child_list_Targeted,
                                                                                    myexposures = NULL,
                                                                                    myoutcomes = child_analytes,mycovars = Age_Sex_Study,join_var = "Child_PID",
...
Child_Age_Sex_Study_Income_Quantile_Results <- Child_SDOH_Metab_Quantile_Results
save(Child_Age_Sex_Study_Income_Quantile_Results, file = "../Output/Final_Paper1_Output/Child_Age_Sex_Study_Income_Quantile_Results.RData")

Age_Sex_Study <- c("Child_Age","Child_Sex","Mat_Edu_Binary","Study")
Child_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Child_SDOH,
                                                                                    Outcome_Data = child_list_Targeted,
                                                                                    myexposures = NULL,
                                                                                    myoutcomes = child_analytes,mycovars = Age_Sex_Study,join_var = "Child_PID",
...
Child_Age_Sex_Study_Edu_Quantile_Results <- Child_SDOH_Metab_Quantile_Results
save(Child_Age_Sex_Study_Edu_Quantile_Results, file = "../Output/Final_Paper1_Output/Child_Age_Sex_Study_Edu_Quantile_Results.RData")


Age_Sex_Study_Location <- c("Child_Age","Child_Sex","Study","Location_Country")
Child_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Child_SDOH,
                                                                                    Outcome_Data = child_list_Targeted,
                                                                                    myexposures = NULL,
                                                                                    myoutcomes = child_analytes,mycovars = Age_Sex_Study_Location,join_var = "Child_PID",
                                                                                    Reg_Type = "Quantile")))

Child_Age_Sex_Study_Location_Quantile_Results <- Child_SDOH_Metab_Quantile_Results
save(Child_Age_Sex_Study_Location_Quantile_Results, file = "../Output/Final_Paper1_Output/Child_Age_Sex_Study_Location_Quantile_Results.RData")


master_covs <- c("Child_Age","Child_Sex","Study","Mat_Edu_Binary","Mat_Child_Comb_Race")
Child_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Child_SDOH,
                                                                                    Outcome_Data = child_list_Targeted,
                                                                                    myexposures = NULL,
                                                                                    myoutcomes = child_analytes,mycovars = master_covs,join_var = "Child_PID",
                                                                                    Reg_Type = "Quantile")))

Child_Age_Master_Model_Results <- Child_SDOH_Metab_Quantile_Results
save(Child_Age_Master_Model_Results, file = "../Output/Final_Paper1_Output/Child_Age_Master_Model_Results.RData")

Study_Only <- c("Study")
Mat_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Mat_SDOH,
                                                                                  Outcome_Data = mat_list_Targeted,
                                                                                  myexposures = NULL,
                                                                                  myoutcomes = mat_analytes,mycovars = Study_Only,join_var = "Mat_PID",
                                                                                  Reg_Type = "Quantile")))

Mat_Study_Quantile_Results <- Mat_SDOH_Metab_Quantile_Results
save(Mat_Study_Quantile_Results, file = "../Output/Final_Paper1_Output/Mat_Study_Quantile_Results.RData")

focused_social_exposures <- c("Mat_Age","Mat_Race","Mat_Edu",
                              "Mat_Income","Mat_Edu_Binary","Mat_Income_Binary",
                              "Edu_Any" ,"Mat_Child_Comb_Race","Location_Country")
...
# Mat_SDOH_Metab_Quantile_Results <- ExWAS_Function_Metab(Exposure_Data = Mat_SDOH,Outcome_Data = mat_list_Targeted,
#                                                  myexposures = names(Mat_SDOH)[-c(1:3)],
#                                                 myoutcomes = mat_analytes,mycovars = "Study",join_var = "Mat_PID",
#                                                 Reg_Type = "Quantile")

Mat_All_Exposure_Quantile_Results <- Mat_SDOH_Metab_Quantile_Results
save(Mat_All_Exposure_Quantile_Results, file = "../Output/Final_Paper1_Output/Mat_Quantile_Results_Study_Adj.RData")

Age <- c("Mat_Age")
Mat_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Mat_SDOH,
                                                                                  Outcome_Data = mat_list_Targeted,
                                                                                  myexposures = NULL,
                                                                                  myoutcomes = mat_analytes,mycovars = Age,join_var = "Mat_PID",
                                                                                  Reg_Type = "Quantile")))

Mat_Age_Quantile_Results <- Mat_SDOH_Metab_Quantile_Results
save(Mat_Age_Quantile_Results, file = "../Output/Final_Paper1_Output/Mat_Quantile_Results_Age.RData")

Age_Study <- c("Mat_Age","Study")
Mat_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Mat_SDOH,
                                                                                  Outcome_Data = mat_list_Targeted,
                                                                                  myexposures = NULL,
                                                                                  myoutcomes = mat_analytes,mycovars = Age_Study,join_var = "Mat_PID",
                                                                                  Reg_Type = "Quantile")))

Mat_Age_Study_Quantile_Results <- Mat_SDOH_Metab_Quantile_Results
save(Mat_Age_Study_Quantile_Results, file = "../Output/Final_Paper1_Output/Mat_Quantile_Results_AgeStudy.RData")

Age_Study <- c("Mat_Age","Mat_Race","Study")
Mat_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Mat_SDOH,
                                                                                  Outcome_Data = mat_list_Targeted,
                                                                                  myexposures = NULL,
                                                                                  myoutcomes = mat_analytes,mycovars = Age_Study,join_var = "Mat_PID",
...
Mat_Age_Study_Race_Quantile_Results <- Mat_SDOH_Metab_Quantile_Results
save(Mat_Age_Study_Race_Quantile_Results, file = "../Output/Final_Paper1_Output/Mat_Age_Study_Race_Quantile_Results.RData")

Age_Study <- c("Mat_Age","Mat_Edu_Binary","Study")
Mat_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Mat_SDOH,
                                                                                  Outcome_Data = mat_list_Targeted,
                                                                                  myexposures = NULL,
                                                                                  myoutcomes = mat_analytes,mycovars = Age_Study,join_var = "Mat_PID",
...
Mat_Age_Study_Edu_Quantile_Results <- Mat_SDOH_Metab_Quantile_Results
save(Mat_Age_Study_Edu_Quantile_Results, file = "../Output/Final_Paper1_Output/Mat_Age_Study_Edu_Quantile_Results.RData")


Age_Study <- c("Mat_Age","Mat_Income_Binary","Study")
Mat_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Mat_SDOH,
                                                                                  Outcome_Data = mat_list_Targeted,
                                                                                  myexposures = NULL,
                                                                                  myoutcomes = mat_analytes,mycovars = Age_Study,join_var = "Mat_PID",
...
Mat_Age_Study_Income_Quantile_Results <- Mat_SDOH_Metab_Quantile_Results
save(Mat_Age_Study_Income_Quantile_Results, file = "../Output/Final_Paper1_Output/Mat_Age_Study_Income_Quantile_Results.RData")

Age_Study_Location <- c("Mat_Age","Study","Location_Country")
Mat_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Mat_SDOH,
                                                                                  Outcome_Data = mat_list_Targeted,
                                                                                  myexposures = NULL,
                                                                                  myoutcomes = mat_analytes,mycovars = Age_Study_Location,join_var = "Mat_PID",
                                                                                  Reg_Type = "Quantile")))

Mat_Age_Study_Location_Quantile_Results <- Mat_SDOH_Metab_Quantile_Results
save(Mat_Age_Study_Location_Quantile_Results, file = "../Output/Final_Paper1_Output/Mat_Age_Study_Location_Quantile_Results.RData")


master_covs <- c("Mat_Age","Mat_Race","Mat_Edu_Binary","Study")
Mat_SDOH_Metab_Quantile_Results <- suppress_all_output(quote(ExWAS_Function_Metab(Exposure_Data = Mat_SDOH,
                                                                                  Outcome_Data = mat_list_Targeted,
                                                                                  myexposures = NULL,
                                                                                  myoutcomes = mat_analytes,mycovars = master_covs,join_var = "Mat_PID",
                                                                                  Reg_Type = "Quantile")))

Mat_Age_Study_Master_Results <- Mat_SDOH_Metab_Quantile_Results
save(Mat_Age_Study_Master_Results, file = "../Output/Final_Paper1_Output/Mat_Age_Study_Master_Results.RData")
